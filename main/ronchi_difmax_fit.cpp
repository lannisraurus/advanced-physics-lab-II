...
int main(){
	...
	//---------------------------------------------------------------
	// Data file info
	std::string dataFile = "data_in/RONCHI1_d8p15mm_s32p8ms_diffraction_maximums.csv";		// Input data file, csv
	std::string resultFile = "data_out/RONCHI1_d8p15mm_s32p8ms_diffraction_maximums.png";	// Output fata file, png
	// Physical System
