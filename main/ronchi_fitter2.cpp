...
int main(){
	...
	double fit_C = 900;
	double fit_a = 0.1366e-3;
	double fit_d = 0.2459e-3;
	double fit_m = 2;
	// Fitting Freedom
	double dfit_E_0 = 2000*pixelToDist/lambdaf;
	double dfit_x0 = 200*pixelToDist;
	double dfit_C = 160;
	double dfit_a = 0.002e-3;
	double dfit_d = 0.002e-3;
	double dfit_m = 30;
	// Display Settings
    ...
    pt->AddText(Form("I = |E_{0}|^{2} (sin(#pia#nu)/(#pi#nu))^{2} (sin(#pimd#nu)/sin(#pid#nu))^{2} + C"));
